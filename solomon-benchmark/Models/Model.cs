...
namespace SolomonBenchmark.Models
{
    public class Model
    {
        public int[] Vehicles => Enumerable.Range(0, VehicleCount).ToArray(); 
        public string Name;
        ...
        public int DepotNode => Customers.FindIndex(IsDepot);
        public bool IsDepot(Customer customer) => customer.Id == 0;
