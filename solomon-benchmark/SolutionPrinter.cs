...
{
    public record SolutionPrinter(Solution Solution)
    {
        public void PrintToStdOut()
        {
            var inputContent = VisualizationMapper.MapBenchmark(Solution.Model);
            var outputContent = VisualizationMapper.MapSolution(Solution);
        ...
        public async Task PrintToFile()
        {
            var inputContent = VisualizationMapper.MapBenchmark(Solution.Model);
            var outputContent = VisualizationMapper.MapSolution(Solution);
            await File.WriteAllTextAsync("C:\\Users\\Bohdan\\Desktop\\input.txt", inputContent);
            await File.WriteAllTextAsync("C:\\Users\\Bohdan\\Desktop\\output.txt", outputContent);
            Console.WriteLine("Done saving to files");
        }
